-- Версия 36 (владелец, 2026-09-17): «то, что приходит в тг, — на русском». v35 перевела сторожа
-- повисших просьб на английский вместе со всем Amestat; теперь исключение: всё, что уходит в
-- Telegram, — по-русски (тексты v9 слово в слово). Тело функции то же, изменены только строки.
