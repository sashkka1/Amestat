...
// Перекрёстность за срок (миграция v29) — дашборд и карточка креатора. Срок, площадка и
// охват те же, что у остальных блоков страницы: иначе «(N) перекрёстных» стояло бы рядом
// с числом, посчитанным по другому набору видео.
//
// ⚠️ Отбора по креатору у функции нет: карточка креатора зовёт её с его площадкой и
// отсеивает чужие строки у себя.
//
