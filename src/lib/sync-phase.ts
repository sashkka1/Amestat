...
// 🔴 Хвоста «· тексты у не наших» больше нет (владелец, 2026-09-09): флаг all_videos не
// выбирается отдельно, а выводится из охвата списка (`comments && videos === 'all'`).
// Про охват уже говорит хвост «· только наши» ниже, и второй хвост о том же самом только
// удлинял строку «Обновлено …».
