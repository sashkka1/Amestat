...
// креаторов (миграция v29). Есть только у плитки «Комментарии»:
...
// `cross` — перекрёстность за тот же срок (миграция v29): её получает только плитка
// «Комментарии», у остальных счётчиков имён нет. Не передан — плитки без метки.
