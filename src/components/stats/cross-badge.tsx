...
// Три числа везде, где показывается число комментариев у видео (владелец, 2026-09-12):
// «20 · 15 · 3» — снято текстов, из них не авторских, из них от других наших креаторов.
// Стоят в таблице видео, в «Лучших видео» и в панели ролика; отдельной колонки
// «Перекрёстно» нет: третье число живёт здесь же, рядом со своими знаменателями.
//
