...
// ⚠️ Вкладки «Amestat Test» больше нет (владелец, 2026-09-12): перекрёстность переехала на
// сам дашборд и на карточку креатора, и отдельной странице под неё места не осталось.
